...
echo "assessmentslink has data " . $assessmentslink . "<br>\n";
    ...
    ?>
    <form action="PGAP_process.php" id="myForm" method="post">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity1', this.value)" list="tickmarks1" id="throbbing"
                            name="pd1">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity2', this.value)" list="tickmarks2" id="shooting"
                            name="pd2">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity3', this.value)" list="tickmarks3" id="stabbing"
                            name="pd3">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity4', this.value)" list="tickmarks4" id="sharp" name="pd4">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity5', this.value)" list="tickmarks5" id="cramping"
                            name="pd5">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity6', this.value)" list="tickmarks6" id="gnawing"
                            name="pd6">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity7', this.value)" list="tickmarks7" id="hotburning"
                            name="pd7">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity8', this.value)" list="tickmarks8" id="hotburning"
                            name="pd8">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity9', this.value)" list="tickmarks9" id="hotburning"
                            name="pd9">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity10', this.value)" list="tickmarks10" id="hotburning"
                            name="pd10">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity11', this.value)" list="tickmarks11" id="hotburning"
                            name="pd11">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity12', this.value)" list="tickmarks12" id="hotburning"
                            name="pd12">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity13', this.value)" list="tickmarks13" id="hotburning"
                            name="pd13">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity14', this.value)" list="tickmarks14" id="hotburning"
                            name="pd14">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="5" value="0"
                            oninput="updateValue('painIntensity15', this.value)" list="tickmarks15" id="hotburning"
                            name="pd15">
                ...
                <tr>
                    ...
                    <td><input type='radio' name='overall' value='0' checked>0 = No Pain</td>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity1', this.value)"
                            list="phqmarks1" id="phq1" name="phq1">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity2', this.value)"
                            list="phqmarks2" id="phq2" name="phq2">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity3', this.value)"
                            list="phqmarks3" id="phq3" name="phq3">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity4', this.value)"
                            list="phqmarks4" id="phq4" name="phq4">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity5', this.value)"
                            list="phqmarks5" id="phq5" name="phq5">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity6', this.value)"
                            list="phqmarks6" id="phq6" name="phq6">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity7', this.value)"
                            list="phqmarks7" id="phq7" name="phq7">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity8', this.value)"
                            list="phqmarks8" id="phq8" name="phq8">
                ...
                <tr>
                    ...
                    <td>
                        <input type="range" min="0" max="3" value="0" oninput="updateValue('phqIntensity9', this.value)"
                            list="phqmarks9" id="phq9" name="phq9">
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="radio" name="difficulty" value="0" checked> Not difficult at all</label>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table>
                ...
                <tr>
                    <td> <label>Family / Home responsibilities</label>
                        <input type="range" min="0" max="10" value="0" oninput="updateValue('family1', this.value)"
                            id="di1" list="diList1" name="di1">
                        <datalist id="diList1">
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                ...
                <tr>
                    <td> <label>Recreation</label>
                        <input type="range" min="0" max="10" value="0" oninput="updateValue('family2', this.value)"
                            id="di2" list="diList2" name="di2">
                        <datalist id="diList2">
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                ...
                <tr>
                    <td> <label>Social Activity</label>
                        <input type="range" min="0" max="10" value="0" oninput="updateValue('family3', this.value)"
                            id="di3" list="diList3" name="di3">
                        <datalist id="diList3">
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                ...
                <tr>
                    <td> <label>Occupation</label>
                        <input type="range" min="0" max="10" value="0" oninput="updateValue('family4', this.value)"
                            id="di4" list="diList4" name="di4">
                        <datalist id="diList4">
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                ...
                <tr>
                    <td> <label>Self-care</label>
                        <input type="range" min="0" max="10" value="0" oninput="updateValue('family5', this.value)"
                            id="di4" list="diList5" name="di5">
                        <datalist id="diList5">
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
            ...
            <table>
                ...
                <tr>
                    <td><label>1. I&apos;m afraid that I might injure myself if I exercise.</label>
                        <input type='radio' name='ffq1' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq2' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq3' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        <label>4. It&apos;s really not safe for a person with my condition to be physically
                            active.</label>
                        <input type='radio' name='ffq4' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq5' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq6' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq7' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq8' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq9' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='ffq10' value='0' checked> 0 </input>
            ...
            <table>
                ...
                <tr>
                    <td><label>1. Most people don’t understand how severe my condition is.</label>
                        <input type='radio' name='cieq1' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq2' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq3' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq4' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq5' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq6' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq7' value='0' checked> 0 </input>
                ...
                <tr>
                    <td><label>8. I can’t seem to keep my condition out of my mind.</label>
                        <input type='radio' name='cieq8' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq9' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq10' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq11' value='0' checked> 0 </input>
                ...
                <tr>
                    <td>
                        ...
                        <input type='radio' name='cieq12' value='0' checked> 0 </input>
