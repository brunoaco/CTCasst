...
<body>
    <div class="container my-4">
        <div class="page-wrapper">
            ...
            <form action="ConsentAgreement_process.php" id="myForm" method="post">

                <h1 class="text-center">Creative Therapy Consultants</h1>
                <p class="small text-center">
                    102-208 Ellis Street, Penticton, BC, V2A 4L6
                    (<a href="https://maps.google.com/?q=102-208+Ellis+Street,+Penticton,+BC,+V2A+4L6"
                ...
                <div class="section">
                    ...
                    <div class="section">
                        ...
                        <div class="col-12 col-md-9"><input type="text" class="form-control" name="print_name1"
                                required=""></div>

                        <div class="col-12 col-md-3 label-col"><label for="date">Date</label></div>
                        <div class="col-12 col-md-9"><input type="date" class="form-control" name="date" required="">
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" name="print_name2" required="" class="form-control">
                        </div>
                        <br>
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="phoneMasked" name="phone" placeholder="(###) ###-####" maxlength="14"
                                inputmode="numeric" required="" class="form-control">
                        </div><br>
                    ...
                    <div class="section">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" class="form-control" name="initials_ltd" maxlength="4" required="">
                        </div>
                        <div class="col-12 col-md-3 label-col">
                            <label class="label-width">Initials (Private Pay)</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" class="form-control" name="initials_private" maxlength="4" required="">
                        </div>
